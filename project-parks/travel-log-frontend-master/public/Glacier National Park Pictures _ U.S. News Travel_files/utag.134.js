//tealium universal tag - utag.134 ut4.0.201811081658, Copyright 2018 Tealium.com Inc. All Rights Reserved.
...
return true;};u.checkFunction=function(fn){if(u.typeOf(fn)==="string"&&window[fn]&&u.typeOf(window[fn])==="function"){return window[fn];}};u.map={};u.extend=[];u.loader_cb=function(a,b,c){utag.DB("send:134:CALLBACK");var c,f,g,_event,_item,_items,_length;u.initialized=true;Sailthru.init(u.data.init);if(u.data.pageviewTracking==="manual"){if(u.data.pageview.url){u.data.pageview.tags=u.data.pageview.tags||{};Sailthru.track("pageview",u.data.pageview);}}
...
if(u.initialized){u.loader_cb(a,b,c);}else{u.queue.push({"data":u.data,"a":a,"b":b,"c":c});if(!u.scriptrequested){u.scriptrequested=true;u.loader({"type":"script","src":u.data.base_url,"cb":u.callBack,"loc":"script","id":"utag_134","attrs":{}});}}
utag.DB("send:134:COMPLETE");}};utag.o[loader].loader.LOAD(id);}("134","usnews.main"));}catch(error){utag.DB(error);}
