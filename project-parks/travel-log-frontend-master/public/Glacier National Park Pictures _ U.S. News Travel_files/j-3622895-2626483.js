...
(function(){
    ...
    (function() {
    var p = "3622895", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3622895||'',
    GUID:window.ftGUID_3622895||'99999999999',
    confID:window.ftConfID_3622895||'0',
    ftReturn: window.ftReturn_3622895||'',
    keyword:window.ftKeyword_3622895||'',
    ftId:window.ftId_3622895||'',
    imp:window.ftImp3622895,
    ftImpId:window.ftImp3622895 && window.ftImp3622895.impID || '',
    campaignID:'104356',
    cID:'106296',
    pID:'3622895',
    creativeID:'2626483',
    exttrack:[],
    extscript:["https://z.moatads.com/twentytwosquaredusft999538191883/moatad.js#moatClientLevel1=104356&moatClientLevel2=8917&moatClientLevel3=3622895&moatClientLevel4=2626483[noCachebuster]"],
    clickTags: ["http://servedby.flashtalking.com/click/8/104356;3622895;2626483;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://order.baskinrobbins.com/?stay=y&utm_source=acuityads&utm_medium=display&utm_content=easter cakes&utm_campaign=prospecting"],
    placementDescription:'2019WhyNowDisplayAcuityAdsDesktopDisplayStandardBannerHolidayProspecting300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv3622895',
    phID:'ftpos3622895',
    frameID:'ftframe3622895',
    expID:'ftexpframe3622895',
    altImgID:'ftalt3622895',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/104356;3622895;2626483;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=http://order.baskinrobbins.com/?stay=y&utm_source=acuityads&utm_medium=display&utm_content=easter cakes&utm_campaign=prospecting',
    altImg:'http://servedby.flashtalking.com/imp/8/104356;3622895;204;gif;AcuityAds;2019WhyNowDisplayAcuityAdsDesktopDisplayStandardBannerHolidayProspecting300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/104356;3622895;271;pixel;AcuityAds;2019WhyNowDisplayAcuityAdsDesktopDisplayStandardBannerHolidayProspecting300x250/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/362/3622895/2626483/js/j-3622895-2626483.js',
    file:'http://cdn.flashtalking.com/106296/2626483/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?137091594-3622895;2626483;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:false,
    segment:window.ftSegment_3622895||'',
    segmentList:window.ftSegmentList_3622895||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3622895 && window.ftImp3622895.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3622895')&&/^https:/.test(document.getElementById('ftscript_m3622895').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3622895'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3622895'],
        ['ftcfid', 'ftConfID_3622895'],
        ['fttime', 'ftTimestamp_3622895'],
        ['ftsection', 'ftSection_3622895'],
        ['ftcustom', 'ftCustom_3622895'],
        ['ft_id', 'ftId_3622895'],
        ['ftimpid','ftImp3622895', 'impID']
    ]
};
...
(function(vals){
    ...
    if(document.readyState === 'loading') {
        ...
        for (var i = 0; i < y.childNodes.length; i++) {
            var node = y.childNodes[i].cloneNode(true);
            ...
            if(o && o.scriptLocation) {
                o.scriptLocation.parentNode.insertBefore(node, o.scriptLocation.parentElement.lastChild.nextSibling);
            }
        }
    }
}(["<script src=\"https:\/\/z.moatads.com\/twentytwosquaredusft999538191883\/moatad.js#moatClientLevel1=104356&moatClientLevel2=8917&moatClientLevel3=3622895&moatClientLevel4=2626483[noCachebuster]&zMoatADV=5879\" type=\"text\/javascript\"><\/script>"]));